...
{
    /// <summary>
    /// Converts an <see cref="ICommand"/> or <see cref="IEvent"/> from/to a flattened structure suitable for storing in 
    /// an <see cref="IEventStore"/>.
    /// </summary>
    public class PropertyBagConverter : IPropertyBagConverter
    {
        ...
        private readonly Dictionary<Type, IPropertyBagPostConverter> converters = new Dictionary<Type, IPropertyBagPostConverter>();
